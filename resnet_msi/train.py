...
from model_resnet import Freeze_ResNet101
import os
import datetime
import sys
...
#exts = ['.tif','.png']
#encoder = ['MSIMUT', 'MSS']
#filepath = '/media/dataa/MSS_MSI'
trainpath = 'target/crc_finaltrain2.csv'
valpath = 'target/crc_final_val.csv'
savepath_train = 'target/crctrainlist.csv'
savepath_val = 'target/crcvallist.csv'
#valratio = 0.2
###########################################################################
...
###########################################################################
model = Freeze_ResNet101(2).to(device)
###########################################################################
